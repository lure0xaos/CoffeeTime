...
public class CTConfig implements Externalizable, ObjectInputValidation {
    ...
    public String format() {
        return CTConfigDataConverter.getInstance()
            .format(TimeUnit.MINUTES, whole, block, warn);
    }
    ...
    private String name(TimeUnit unit) {
        return MessageFormat.format("{0,number,00}/{1,number,00}", getWhole(unit), getBlock(unit));
    }
