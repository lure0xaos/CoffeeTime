...
public final class CTBlockerContent extends JPanel implements CTTaskUpdatable, CTWindow, CTInformer {
    ...
    private static final double FONT_SCALING_INFO_SMALL = 31;
    private static final double FONT_SCALING_MAIN_BIG = 10;
    private static final double FONT_SCALING_MAIN_SMALL = 9;
    ...
    private void adjust(boolean big, JLabel label, double fontScaling) {
        if (!isVisible()) return;
