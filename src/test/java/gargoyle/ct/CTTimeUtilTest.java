...
public class CTTimeUtilTest {
    ...
    public void testBetweenEagerSec() {
        ...
        Assert.assertFalse(CTTimeUtil.isBetween(unit, CTTimeUtil.fromMillis(unit, eager), CTTimeUtil.fromMillis(unit,
                                                                                                                start),
    ...
    public void testDownTo() {
        ...
        Assert.assertEquals(MessageFormat.format(DOWN_TO_FAILED_0_1, CTTimeUtil.formatHHMMSS(expected),
                                                 CTTimeUtil.formatHHMMSS(actual)), expected, actual);
    }
    ...
    public void testToBase() {
        ...
        Assert.assertEquals(MessageFormat.format(BASE_FAILED_0_1, CTTimeUtil.formatHHMMSS(current), CTTimeUtil
                                    .formatHHMMSS(base)),
                            expected,
                            base);
        Assert.assertEquals(MessageFormat.format(BASE_2_FAILED_0_1, CTTimeUtil.formatHHMMSS(current), CTTimeUtil.formatHHMMSS(base2)),
                            expected, base2);
        Assert.assertEquals(MessageFormat.format(BASE_3_FAILED_0_1, CTTimeUtil.formatHHMMSS(current), CTTimeUtil.formatHHMMSS(base3)),
                            expected, base3);
    }
    ...
    public void testUpTo() {
        ...
        long expected = calendar.getTimeInMillis();
        Assert.assertEquals(MessageFormat.format(UP_TO_FAILED_0_1, CTTimeUtil.formatHHMMSS(expected), CTTimeUtil.formatHHMMSS(actual)),
                            expected, actual);
    }
}
